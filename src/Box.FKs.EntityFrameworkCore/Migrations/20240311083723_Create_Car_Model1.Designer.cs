...
namespace Box.FKs.Migrations
{
    ...
    [Migration("20240311083723_Create_Car_Model1")]
    partial class Create_Car_Model1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Box.FKs.Domain.Car", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Box.FKs.Domain.Person", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Box.FKs.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Box.FKs.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Box.FKs.Domain.Car", b =>
                {
                    b.HasOne("Box.FKs.Domain.Person", "PersonModel")
                        .WithMany()
