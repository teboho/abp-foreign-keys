...
{
    public abstract class FKsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FKsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FKsWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<FKsDbContext> action)
        {
            using (var context = IocManager.Resolve<FKsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<FKsDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<FKsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FKsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FKsDbContext, Task<T>> func)
        {
            T result;
